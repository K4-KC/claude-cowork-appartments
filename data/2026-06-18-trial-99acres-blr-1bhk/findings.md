...
_Can you see listings without logging in? What modal/popup interrupts, when does it fire, and can it be dismissed without an account? (99acres is known for interstitials.)_
...
## Sample captured
_How many listings written to `99acres.csv`, and any row that needed a `notes` caveat (and why)._
