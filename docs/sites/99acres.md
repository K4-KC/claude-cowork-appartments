...
- **Active trial run:** `data/2026-06-18-trial-99acres-blr-1bhk/` (brief + findings template + sample CSV).
- Reference recipe: `docs/sites/housing.md` (built on the same filters — note where 99acres differs).
...
|---|---|---|
| _2026-06-18_ | _Trial set up; awaiting Cowork's first pass._ | _Run `data/2026-06-18-trial-99acres-blr-1bhk/` per `docs/trial-protocol.md`._ |
