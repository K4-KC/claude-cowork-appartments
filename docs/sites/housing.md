...
How Cowork should browse and extract from Housing.com. **To be filled in via trial and testing** — record what works, what breaks, and the exact UI steps as you learn them.

## Trial status

- **Status:** First-contact trial in progress. Method to follow: `docs/trial-protocol.md`.
- **Active trial run:** `data/2026-06-18-trial-housing-blr-1bhk/` (brief + sample CSV).
...
|---|---|---|
| _2026-06-18_ | _Trial set up; awaiting Cowork's first pass._ | _Run `data/2026-06-18-trial-housing-blr-1bhk/` per `docs/trial-protocol.md`._ |
